...
The project is built using Rust (full-stack) and is organized as a workspace consisting of two major groups:
...
- Distributed agents, with the ability to run components on different machines.
- Provides a dynamic user interface (UI) that is automatically generated for interacting with a network of agents.
